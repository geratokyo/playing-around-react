...
export class InteractiveSvgMap extends React.Component<InteractiveSvgMapProps, InteractiveSvgMapState>{
    ...
    // some props are passed as param some used from this.props
    onClick = (ev, evType, isInteractive) => {
    ...
    render() {
        ...
        return (
            <div
                ...
                ref={e => this.el = e}
                onClick={(ev) => this.onClick(ev, this.props.eventType, this.props.isInteractive)}
